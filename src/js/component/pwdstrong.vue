<template>
    <ul class="pass_set">
        <li class="strength_L" :style="{'background-color':color.Lcolor}">弱</li>
        <li class="strength_M" :style="{'background-color':color.Mcolor}">中</li>
        <li class="strength_H" :style="{'background-color':color.Hcolor}">强</li>
    </ul>
</template>
<script>
export default {
